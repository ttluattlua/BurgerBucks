...
import bbc.com.a.service.BbcStatisticService;
import bbc.com.a.service.BbcStoreSerivce;

@Controller
public class BbcLoginController {
	private static final Logger logger = LoggerFactory.getLogger(BbcLoginController.class);
	
	@Autowired
	BbcMemberSerivce bbMemberService;

	@Autowired
	BbcStatisticService bbaStatisticService;
