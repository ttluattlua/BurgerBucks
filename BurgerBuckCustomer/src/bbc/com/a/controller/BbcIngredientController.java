...
import bbc.com.a.arrow.FileUploadMethod;
import bbc.com.a.model.Bb_ImageDto;
import bbc.com.a.model.Bb_IngredientDto;
import bbc.com.a.service.BbcIngredientService;


@Controller
public class BbcIngredientController {
	private static final Logger logger = LoggerFactory.getLogger(BbcIngredientController.class);

	@Autowired
	BbcIngredientService bbaIngredientService;
