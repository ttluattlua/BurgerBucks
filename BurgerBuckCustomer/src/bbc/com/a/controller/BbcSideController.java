...
import bbc.com.a.service.BbcSideService;

@Controller
public class BbcSideController {
	private static final Logger logger = LoggerFactory.getLogger(BbcSideController.class);

	@Autowired
	BbcSideService bbaSideService;
