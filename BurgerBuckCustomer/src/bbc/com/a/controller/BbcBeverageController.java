...
@Controller
public class BbcBeverageController {
	private static final Logger logger = LoggerFactory.getLogger(BbcBeverageController.class);

	@Autowired
	BbcBeverageService bbaBeverageService;
