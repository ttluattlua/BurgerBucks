 ...
 * -----------------------------------------------------------------------------*/
public class BB_DiyBurgerDto implements Serializable {
	private int seq;				//시퀀스
	...
	public BB_DiyBurgerDto() {}
	
	public BB_DiyBurgerDto(int seq, String name, Bb_IngredientDto breadCls, Bb_IngredientDto ingredientsCls1,
