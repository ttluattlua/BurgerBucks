...
import bb.com.a.arrow.FileUploadMethod;
import bb.com.a.arrow.directoryFinder;
import bb.com.a.arrow.xmlParser;
...
@Controller
public class BbIngredientController {
	private static final Logger logger = LoggerFactory.getLogger(BbIngredientController.class);
  ...
  String uploadPath;	
	...
	public String ingredientlist(Model model, HttpServletRequest req) {
		...
		List<Bb_IngredientDto> IngList = bbIngredientService.getIngList();
  ...
  bbdto = bbIngredientService.registerIng(bbdto, bidto);
  ...
  return bbdtoJson;
	...
	@RequestMapping(value = "updateIng.do", method= {RequestMethod.GET, RequestMethod.POST}, produces = "application/json; charset=utf8")
	    public String updateIng(@RequestBody Map<String, Object> map) {
			...
			Bb_IngredientDto bbdto = bbIngredientService.getIngDetail(seq);
	    ...
	    public String updateIngAf(@RequestParam("image_src")MultipartFile multi, Bb_IngredientDto bbdto, HttpServletRequest req) {
	        ...
	        // 저장 경로 설정
		 	...
		 	if(originalFile.equals("") || originalFile == null) {
		 		...
		 		bbIngredientService.updateIngAf(bbdto);
	...
	public Map<String, Object> deleteIng(@RequestBody Map<String, Object> map) {
		...
		bbIngredientService.deleteIng(seq, image_Seq);
